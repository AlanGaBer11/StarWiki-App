...
export const STMOVIES: PeliculaData[] = [
  ...
  },
  {
    ...
    imagen: "/img/st-episodios/7.webp",
    link: "/star-wars/trilogia-secuelas",
    //link: "/star-wars-episodio-vii-el-despertar-de-la-fuerza",
  },
  {
    titulo: "Episodio VIII - Los Últimos Jedi",
    descripcion:
      "Mientras la Resistencia se encuentra al borde de la extinción, Rey busca al legendario Luke Skywalker, esperando que su regreso traiga esperanza. Sin embargo, Luke está atormentado por errores del pasado que lo llevaron a un autoexilio. A medida que Rey explora el poder de la Fuerza, descubre secretos que cambiarán su visión del bien y del mal. Y en el corazón de la Primera Orden, Kylo Ren lucha con sus propios demonios. La línea entre héroes y villanos se desdibuja en una batalla donde la verdad podría destruir todo en lo que creían",
    imagen: "/img/st-episodios/8.webp",
    link: "/star-wars/trilogia-secuelas",
    //link: "/star-wars-episodio-viii-los-ultimos-jedi",
  },
  {
    titulo: "Episodio IX - El Ascenso de Skywalker",
    descripcion:
      "La lucha final entre la Resistencia y la Primera Orden llega a su clímax, y Rey, la última esperanza de los Jedi, debe enfrentarse a su destino y descubrir la verdad de sus orígenes. En una carrera contra el tiempo, viejos enemigos y sorprendentes revelaciones pondrán a prueba su fe y su poder. Con la ayuda de sus amigos y aliados, Rey deberá tomar decisiones que marcarán el futuro de la galaxia y enfrentar un mal antiguo que amenaza con resurgir. ¿Será Rey capaz de traer equilibrio a la Fuerza... o caerá ante su oscuro legado?",
    imagen: "/img/st-episodios/9.webp",
    link: "/star-wars/trilogia-secuelas",
    //link: "/star-wars-episodio-ix-el-ascenso-de-skywalker",
  },
];

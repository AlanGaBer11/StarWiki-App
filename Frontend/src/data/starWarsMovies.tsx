...
export const STMOVIES: PeliculaData[] = [
  ...
  },
  {
    ...
    descripcion:
      "La galaxia vive bajo el yugo del implacable Imperio Galáctico, que no conoce límites en su búsqueda de dominación. Sin embargo, una chispa de esperanza nace cuando un grupo de valientes rebeldes roba los planos de una temible estación de combate: la Estrella de la Muerte. En este momento de crisis, Luke Skywalker, un joven granjero de Tatooine, descubre su verdadero destino y emprende una misión que lo cambiará para siempre. Junto a un contrabandista astuto, una princesa rebelde y un par de droides, Luke desafiará al imperio... y descubrirá el poder de la Fuerza.",
